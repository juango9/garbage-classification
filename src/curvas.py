...
def graf_pedida(hist,save_path=None):
...
def graf_acc(hist,save_path=None):
...
def plot_confusion(y_true, y_pred, class_names, title='Matriz de confusion',save_path=None):
